...
namespace Accord.DataSets
{
    ...
    ///   References:
    ///   <list type="bullet">
    ///     <item><description><a href="https://archive.ics.uci.edu/ml/datasets/wine">
    ...
    public class Wine
    {
        ...
        /// <summary>
        ///   Gets the name of each variable in the Wine dataset.
        /// </summary>
        /// 
        ...
        /// <summary>
        ///   Gets the class labels for the <see cref="Instances">data in the Wine dataset</see>.
        /// </summary>
        /// 
        public int[] ClassLabels { get; private set; }

        /// <summary>
        ///   Prepares the Wine dataset from UCI's Irvine Repository.
        /// </summary>
        /// 
        public Wine()
        {
            ...
            for (int i = 0; i < ClassLabels.Length; i++)
                ClassLabels[i] = (int)data[i, 0];

            Instances = new double[n][];
            for (int i = 0; i < Instances.Length; i++)
            {
                Instances[i] = new double[13];
                for (int j = 0; j < Instances[i].Length; j++)
                    Instances[i][j] = data[i, j + 1];
            }
        }

...
namespace Accord.DataSets
{
    ...
    public class Nursery : WebDataSet
    {
            ...
            : base(path)
        {
            ...
            Download("https://archive.ics.uci.edu/ml/machine-learning-databases/nursery/nursery.data", Path, "nursery.data", out uncompressedFileName);
            //Download("http://onedrive.live.com/download?cid=808347681CC09388&resid=808347681CC09388%21530794&authkey=AObheTbGp_LOi-U", Path, "nursery.data", out uncompressedFileName);
